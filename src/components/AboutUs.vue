<template>
  <section class="about container">
    <div class="about__left-wrap">
      <h2 class="about__title">О площадке</h2>
    ...
    <form action="#" method="post" class="about__right-wrap">
      <h4 class="about__form-title">Оставить заявку на проведение концерта</h4>
      <textarea
        name="#"
        id=""
        placeholder="Расскажите о вашем предложении"
        class="about__form-textarea"
      ></textarea>
      <input
        type="submit"
        class="about__form-send card-profile__link"
        value="Отправить"
      />
    </form>
  </section>
